...
export default function Navbar() {
  ...
  return (
    <nav className="dark:bg-gray-900 sticky top-0 z-50 bg-transparent lg:border-b lg:border-gray-700">
      <div
      ...
      >
        ...
        <div
          className={`${!openNavBar ? "hidden" : "backdrop-blur-lg"} w-full md:block md:w-auto`}
          id="navbar-default"
        >
          <ul
