...
const ContactUs = () => {
  return (
    <>
      <BackgroundImage header="Contacts" />
      <div className="mb-20">
      ...
      <div className="flex flex-col justify-center items-center mb-20">
        <div
          className="block w-full lg:w-3/4 cursor-pointer bg-gray-100 border
             border-gray-200 rounded-lg shadow-sm 
             hover:bg-orange-100 dark:bg-gray-800 dark:border-gray-700
              dark:hover:bg-gray-700"
        >
          <h1 className="font-bold text-2xl lg:text-6xl text-center py-3">
            Nairobi Office
          </h1>
          ...
          <div className="flex flex-col lg:flex-row gap-4 mt-10 justify-center lg:justify-start lg:px-50 items-center">
            ...
            <p className="text-xl font-semibold text-center lg:text-start py-3">
          ...
          <div className="flex flex-col lg:flex-row gap-4 mt-10 justify-center lg:justify-start lg:px-50 items-center">
            ...
            <p className="text-xl font-semibold break-all text-center lg:text-start py-3">
          ...
          <div className="flex flex-col lg:flex-row gap-4 mt-10 justify-center lg:justify-start lg:px-50 items-center">
            <img className="w-10 h-10" src={envelope} alt="envelope" />
            <p className="text-xl break-all font-semibold text-center lg:text-start py-3">
