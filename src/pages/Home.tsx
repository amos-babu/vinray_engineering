    ...
    <div className="flex flex-col relative h-screen w-full">
      ...
      >
        ...
        <div className="flex flex-col lg:flex-row md:flex-row gap-4">
          <Link to={`/contact-us`}>
            <button className="cursor-pointer px-10 mt-3 py-3 text-sm bg-orange-600 rounded-lg hover:bg-orange-800">
              Contact Us
            </button>
          </Link>

          <Link to={`/about-us`}>
            <button className="cursor-pointer px-10 mt-3 py-3 text-sm border pointer-cursor hover:text-orange-600 rounded-lg">
              Learn More
            </button>
          </Link>
        </div>
